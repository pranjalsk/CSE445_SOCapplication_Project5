...
<body class="container">
    <div class="wrapper">
        <form class="container" runat="server">
            ...
            <asp:Button ID="btn_viewAll" CssClass="btn btn-lg btn-primary wrapper" runat="server" Text="View All" />
            &nbsp;&nbsp;<br />
            ...
            <div>
                <asp:Button ID="btn_BookNow" CssClass="btn btn-lg btn-primary wrapper" runat="server" Text="Book This House" /><br />
